...
Shader "Particle/FX_MasterV2_Addtive"
{
	Properties
	{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 tex2DNode25 = tex2D( _Main_Texture, ( ( UnpackNormal( tex2D( _Distortion_Texture, uv_TexCoord51 ) ) * lerp(_Distortion_Intensity,i.uv3_tex4coord3.y,_Use_CustomData) ) + float3( uv_TexCoord26 ,  0.0 ) ).xy );
			o.Emission = ( lerp(_Burn,i.uv3_tex4coord3.x,_Use_CustomData) * ( tex2DNode25 * i.vertexColor ) ).rgb;
			float4 appendResult133 = (float4(_Mask_U_Tiling , _Mask_V_Tiling , 0.0 , 0.0));
			float2 appendResult129 = (float2(0.0 , lerp(0.0,i.uv3_tex4coord3.w,_Use_CustomData)));
			float2 uv_TexCoord126 = i.uv_texcoord * appendResult133.xy + appendResult129;
			float4 tex2DNode100 = tex2D( _Mask_Texture, uv_TexCoord126 );
			float4 temp_output_108_0 = ( tex2DNode25 * tex2DNode100 );
			float4 temp_cast_8 = (_Dissolve_Sharpness).xxxx;
			float4 clampResult119 = clamp( ( temp_output_108_0 * pow( ( ( 0.5 * temp_output_108_0 ) + lerp(_Dissolve,i.uv3_tex4coord3.z,_Use_CustomData) ) , temp_cast_8 ) ) , float4( 0,0,0,0 ) , float4( 1,0,0,0 ) );
...
/*ASEBEGIN
Version=17000
2658;105.3333;2219;1198;5169.397;-203.5529;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;34;-3581.056,-380.1262;Float;False;Property;_Distortion_U_Panning;Distortion_U_Panning;8;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;51;-2761.133,-464.6959;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;130;-4660.676,951.0117;Float;False;Constant;_Mask_Panning_V;Mask_Panning_V;20;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-2686.194,-201.3269;Float;False;Property;_Distortion_Intensity;Distortion_Intensity;7;0;Create;True;0;0;False;0;0.2;2.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;122;-4495.423,122.697;Float;False;2;-1;4;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;132;-4159.047,699.5565;Float;False;Property;_Mask_V_Tiling;Mask_V_Tiling;17;0;Create;True;0;0;False;0;1;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;127;-4610.445,815.0759;Float;False;Constant;_Tile_U;Tile_U;19;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;131;-4164.318,441.2174;Float;False;Property;_Mask_U_Tiling;Mask_U_Tiling;16;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;128;-4384.067,929.5034;Float;False;Property;_Use_CustomData;Use_CustomData;17;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;123;-2396.264,-188.621;Float;False;Property;_Use_CustomData;Use_CustomData;18;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.DynamicAppendNode;129;-4020.207,877.4959;Float;False;FLOAT2;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.DynamicAppendNode;133;-3921.827,569.8845;Float;False;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;126;-3812.662,851.1348;Float;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;25;-1653.566,48.71509;Float;True;Property;_Main_Texture;Main_Texture;0;0;Create;True;0;0;False;0;9438e7af5347eaa448c6aad37f252544;ab21ae87b20e6374eb5854d3fcd386e0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;125;-2861.768,1048.683;Float;False;Property;_Use_CustomData;Use_CustomData;17;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;79;-1272.749,-102.0719;Float;False;Property;_Burn;Burn;6;0;Create;True;0;0;False;0;1;12.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;75;-495.7512,91.84303;Float;False;True;2;Float;ASEMaterialInspector;0;0;Unlit;Particle/FX_MasterV2_Addtive;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;2;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;False;0;True;Transparent;;AlphaTest;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;False;8;5;False;-1;1;False;-1;8;5;False;-1;1;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;9;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=285F08F7D99F01465374756F85FED820BAF596D7